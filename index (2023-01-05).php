...
<html>
	...
	<body style="background-color: #38342F ;">
		...
		<div id="wrap" style="position:relative; border:1.5px solid #F5F4F1; width:2010px;height:840px;border-radius: 4px;">
			...
			<div style="position:absolute;top:720px;left:807px;">
			    <span style="position:relative;top:-35px;left:77px;">V21</span>
				<img id="V21" src="images/horizontal_closed.png" onclick="var status=$('#V21_label').html();toggleValve('V21',status);" style="width:50px;"/>
			...
			<div style="position:absolute;top:740px;left:1340px;">
				...
				<img id="V32" src="images/vertical_closed.png" onclick="var status=$('#V31_label').html();toggleValve('V32',status);" style="width:50px;"/>
			...
			<div id='pressureA' class="box" style="top:555px;left:620px;width:50px;"><em>NaN</em></div>
				<p class="label" style="top:513px;left:620px;">A (mbar)</p>
			<img id="loadingA" src="" style="width:25px;position:absolute;top:585px;left:620px;" />
			...
			<!-- The pCO2 element is identical to mr3 but it is a number not a text, it is not necessary to be visible -->
			<div id="pCO2" class="box" style="top:160px;left:1200px;">undefined</div>
			...
			<p class="label" style="top:308px;left:858px;">Edwards (mbar)</p>
			...
			<span id="moveStatus" class="info" style="top:120px;left:1670px;text-align:right;">-</span>
			<div id='methodStatus' class="info" style='top:120px;left:1370px;'>Standby</div>
		
			<button type='button' class="button" style='font-size:24px;top:25px;left:1100px;height:60px; width:188px; background-color:#63A615; color:#ffffff;' onclick='createFolder();$("#methodStatus").html("Method running");var timeMeasurementStarted = parseInt( new Date().getTime() / 1000 );$("#timeMeasurementStarted").html( timeMeasurementStarted );$("#sample0").prepend("&#9758; ");'>Start method</button>
			...
			<button onclick="startingPosition();" class="button" style="top:790px;left:30px;width:120px;height:28px;">Starting Position</button>
			
			<a href="http://192.168.1.1/isotope/Isotopes_data_list.php?MaxNumber=20&SampleTypeSearch=CO2" target="_blank"> <button class="button" style="top:140px;left:1700px;width:120px;height:28px;">See results</button></a>
