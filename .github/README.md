...
it under the terms of the [GNU General Public License version 3](.github/LICENSE), or (at your option) any later version. This program is distributed in the hope that it will be useful,
but without any warranty.

Please follow the [provided citation format](.github/CITATION.cff) when referencing this software.
